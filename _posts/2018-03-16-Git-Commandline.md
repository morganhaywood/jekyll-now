...
`git stash` will add your current uncommitted changes to you stash. `git stash list` and `git stash show` will show you what's currently in your stash (in slightly different formats). Finally, `git stash apply` will apply the top of the stash to your current working branch.
