...
The following is a list of commands I have come across generally, and also by doing the Over The Wire Bandit game. A cheatsheet for these can be found [here]({{site.url}}/cheatsheets/cli_cheatsheet.pdf).
